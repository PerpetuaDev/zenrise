...
(function () {
  ...
  var DICT = {
    en: {
      ...
      home_dest_1_item_1: 'Tsurugaoka Hachimangu, Kamakura',
      home_dest_1_item_2: 'Hase-dera, Kamakura',
      home_dest_1_item_3: 'Soji-ji, Yokohama',
      home_dest_1_item_4: 'Senso-ji, Tokyo',
      home_dest_1_item_5: 'Meiji Jingu, Tokyo',
      ...
      home_dest_6_lead: 'The culture, customs, and daily rhythms that give Kamakura its depth.',
    ...
    ja: {
      ...
      home_dest_1_item_1: '鶴岡八幡宮（鎌倉）',
      home_dest_1_item_2: '長谷寺（鎌倉）',
      home_dest_1_item_3: '総持寺（横浜）',
      home_dest_1_item_4: '浅草寺（東京）',
      home_dest_1_item_5: '明治神宮（東京）',
      ...
      home_dest_6_lead: '鎌倉に深みを与える、文化と習慣、そして日々の営み。',
