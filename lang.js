...
(function () {
  ...
  var DICT = {
    en: {
      ...
      about_intro_1: 'We are a two-person walking tour business based in Fujisawa. We design thoughtful, locally-led walking tours through the lesser-known corners of the Shonan coast.',
      ...
      booking_s2_full_p: 'Two towns linked by local train. Morning walk, lunch with the day\u2019s host, an afternoon stop.',
    ...
    ja: {
      ...
      about_intro_1: '藤沢を拠点とする、二人組のウォーキングツアー会社です。湘南海岸の知られざる場所を、地元の目線で歩く丁寧なツアーを企画しています。',
      ...
      booking_s2_full_p: '二つの町を地元の電車でつなぎます。朝の散歩、その日の案内人との昼食、午後の立ち寄り先。',
